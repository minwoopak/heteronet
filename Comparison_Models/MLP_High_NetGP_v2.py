...
parser.add_argument('--model_name', type=str, default='MLP_High_NetGP_v2')
...
expression_fpath = os.path.join(args.datadir, 'drug_response', 'expression_highNetGP_genes_data_total.pt')

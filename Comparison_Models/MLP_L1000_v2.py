...
parser.add_argument('--model_name', type=str, default='MLP_L1000_v2')
...
parser.add_argument('--cell_dim', type=int, default=978)
...
expression_fpath = os.path.join(args.datadir, 'drug_response', 'expression_l1000_genes_data_total.pt')

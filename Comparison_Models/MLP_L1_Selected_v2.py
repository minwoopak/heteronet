...
parser.add_argument('--model_name', type=str, default='MLP_L1_Selected_v2')
...
expression_fpath = os.path.join(args.datadir, 'drug_response', 'expression_L1Selected_genes_data_total.pt')

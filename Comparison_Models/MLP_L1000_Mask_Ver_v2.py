...
parser.add_argument('--model_name', type=str, default='MLP_L1000_Mask_Ver_v2')
...
expression_fpath = os.path.join(args.datadir, 'drug_response', 'expression_L1000_mask_genes_data_total.pt')
